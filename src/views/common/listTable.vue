<template>
  <div class="list-table">
    <el-table :data="tableData" border stripe style="width: 100%" :cell-style="{'text-align':'center'}" :header-cell-style="{ 'text-align':'center',background:'#243D75',color:'rgba(255,255,255,1)',height:'50px'}">
      <el-table-column
